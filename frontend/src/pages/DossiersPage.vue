    ...
    <div class="page-shell">
      ...
      <div class="surface-card q-mb-md">
        <div class="row q-col-gutter-md items-end">
          <div class="col-12 col-md-5">
            <q-input v-model="filters.q" dense outlined clearable label="Rechercher" debounce="300" @update:model-value="load">
          ...
          <div class="col-12 col-md-3">
            <q-btn outline color="primary" label="Actualiser" class="full-width" icon="refresh" @click="load" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <template #body-cell-actions="props">
          <q-td :props="props">
            <q-btn flat dense round icon="visibility" color="primary" :to="{ name: 'dossier-detail', params: { id: props.row.id } }" />
          </q-td>
        </template>
      </q-table>
    </div>
...
const columns = [
  ...
  { name: 'updated_at', label: 'Mis à jour', field: (r) => formatDate(r.updated_at), align: 'left' },
